...
const Footer = () => {
  return (
    <footer className="mt-40 pt-4 bg-gray-800">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="justify-between items-center gap-12 md:flex">
                    ...
                    <div className="flex-1 mt-3 md:mt-0">
                        <form onSubmit={(e) => console.log("submitted")} className="flex items-center gap-x-3 md:justify-end">
                ...
                <div className="mt-5 py-5 border-t items-center justify-between sm:flex">
                    <p className="text-gray-600 font-serif text-white">© 2022 Float UI Inc. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-400 mt-3">
